...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `´ ✊🏾*•.¸♥¸.•** 𝐣𝐡𝐨𝐧**•.¸♥¸.•*´✊🏾`, dev, '', `🇻🇪 Venezuela`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Un Bot 🐉`, `${packname}`, `📵 No Hacer Spam`, '`, `https://github.com/TOKIO5025/Misa-amane-Bot`, biobot]
], m)
